 ...
 */
class NameLabel extends Composite implements ValueAwareEditor<ProductItemProxy> {
  /**
  ...
  private ProductItemProxy ProductItem;
    ...
    if (eventBus != null) {
      nameEditor.addClickHandler(new ClickHandler() {
        public void onClick(ClickEvent event) {
          eventBus.fireEvent(new EditPersonEvent(ProductItem));
        }
      });
    }
  }
  ...
  public void setDelegate(EditorDelegate<ProductItemProxy> delegate) {
  ...
  public void setValue(ProductItemProxy value) {
    ProductItem = value;
  }
